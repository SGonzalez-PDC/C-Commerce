/*
    ...
    - Tabla STAGE_FFA..c_commerce_cart_chosen_promo: guarda la promo elegida por
...
IF OBJECT_ID('STAGE_FFA.dbo.c_commerce_cart_chosen_promo', 'U') IS NULL
BEGIN
...
BEGIN
    ...
    BEGIN TRY
        ...
        IF @accion = 'U'
        BEGIN
            MERGE STAGE_FFA..c_commerce_cart_chosen_promo AS t
        ...
        ELSE IF @accion = 'D'
        BEGIN
            DELETE FROM STAGE_FFA..c_commerce_cart_chosen_promo
