...
* DESCRIPCION: CRUD del encabezado del carrito conversacional de c-commerce (acciones C, GC, R, RS, U, US, D). Las tablas viven en STAGE_FFA (referencia cross-db).
* MODIFICACIONES:
    ...
    BEGIN TRY
        ...
        BEGIN
            IF @price_list_eff IS NULL
                ...
                FROM STAGE_FFA..clientes s
                LEFT JOIN STAGE_FFA..listado_precios L
        ...
        BEGIN
            ...
            INSERT INTO STAGE_FFA..ffa_tbl_txn_header_cart (
        ...
        BEGIN
            ...
            BEGIN
                ...
                UPDATE STAGE_FFA..ffa_tbl_txn_header_cart
        ...
        BEGIN
            ...
            FROM STAGE_FFA..CXC_DireccionCliente dc
            INNER JOIN STAGE_FFA..ffa_tbl_txn_header_cart h ON h.codcliente = dc.CodCliente AND h.empresa = dc.Empresa
            WHERE h.cart_id = @cart_id
              AND h.empresa = @empresa
              AND dc.status = 'S'
        END
        ...
        BEGIN
            ...
            DELETE FROM STAGE_FFA..ffa_tbl_txn_header_cart WHERE cart_id = @cart_id AND empresa = @empresa;
