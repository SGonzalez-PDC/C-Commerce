...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            FROM DEV_FFA..ffa_tbl_txn_header_cart
        ...
        INNER JOIN DEV_FFA..LISTADO_PRECIOS lp
        ...
        IF @lista IS NULL
            SELECT TOP 1 @lista = e.lista_base FROM DEV_FFA..EMPRESA e WHERE e.cod_empresa = @empresa;
        ...
        ;WITH historial AS (
            ...
            FROM DEV_FFA..FACTURA f
            INNER JOIN DEV_FFA..DETFACT d
        ...
        OUTER APPLY (
            ...
            FROM DEV_FFA..Inv_UniMedArticulo iu
        ...
        WHERE pr.precio IS NOT NULL
          AND (@cart_id IS NULL OR NOT EXISTS (
                    SELECT 1 FROM DEV_FFA..ffa_tbl_txn_detail_cart dc
