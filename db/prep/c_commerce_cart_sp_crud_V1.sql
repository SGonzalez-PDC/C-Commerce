...
* DESCRIPCION: CRUD del encabezado del carrito conversacional de c-commerce (acciones C, GC, R, RS, U, US, D). Las tablas viven en PREP_FFA (referencia cross-db).
* MODIFICACIONES:
    ...
    BEGIN TRY
        ...
        BEGIN
            IF @price_list_eff IS NULL
                ...
                FROM PREP_FFA..clientes s
                LEFT JOIN PREP_FFA..listado_precios L
        ...
        BEGIN
            ...
            INSERT INTO PREP_FFA..ffa_tbl_txn_header_cart (
        ...
        BEGIN
            ...
            BEGIN
                ...
                UPDATE PREP_FFA..ffa_tbl_txn_header_cart
        ...
        BEGIN
            ...
            DELETE FROM PREP_FFA..ffa_tbl_txn_header_cart WHERE cart_id = @cart_id AND empresa = @empresa;
