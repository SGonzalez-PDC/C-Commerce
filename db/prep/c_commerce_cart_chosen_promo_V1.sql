/*
    ...
    - Tabla PREP_FFA..c_commerce_cart_chosen_promo: guarda la promo elegida por
...
IF OBJECT_ID('PREP_FFA.dbo.c_commerce_cart_chosen_promo', 'U') IS NULL
BEGIN
...
BEGIN
    ...
    BEGIN TRY
        ...
        IF @accion = 'U'
        BEGIN
            MERGE PREP_FFA..c_commerce_cart_chosen_promo AS t
        ...
        ELSE IF @accion = 'D'
        BEGIN
            DELETE FROM PREP_FFA..c_commerce_cart_chosen_promo
