...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            FROM PREP_FFA..ffa_tbl_txn_header_cart
        ...
        FROM PREP_FFA..CLIENTES c
        INNER JOIN PREP_FFA..LISTADO_PRECIOS lp
        ...
        IF @lista IS NULL
            SELECT TOP 1 @lista = e.lista_base FROM PREP_FFA..EMPRESA e WHERE e.cod_empresa = @empresa;
        ...
        ;WITH historial AS (
            ...
            FROM PREP_FFA..FACTURA f
            INNER JOIN PREP_FFA..DETFACT d
        ...
        OUTER APPLY (
            ...
            FROM PREP_FFA..Inv_UniMedArticulo iu
        ...
        WHERE pr.precio IS NOT NULL
          AND (@cart_id IS NULL OR NOT EXISTS (
                    SELECT 1 FROM PREP_FFA..ffa_tbl_txn_detail_cart dc
