...
* DESCRIPCION: CRUD del encabezado del carrito conversacional de c-commerce (acciones C, GC, R, RS, U, US, D). Las tablas viven en FFA (referencia cross-db).
* MODIFICACIONES:
    ...
    BEGIN TRY
        ...
        BEGIN
            IF @price_list_eff IS NULL
                ...
                FROM FFA..clientes s
                LEFT JOIN FFA..listado_precios L
        ...
        BEGIN
            ...
            INSERT INTO FFA..ffa_tbl_txn_header_cart (
        ...
        BEGIN
            ...
            BEGIN
                ...
                UPDATE FFA..ffa_tbl_txn_header_cart
        ...
        BEGIN
            ...
            FROM FFA..CXC_DireccionCliente dc
            INNER JOIN FFA..ffa_tbl_txn_header_cart h ON h.codcliente = dc.CodCliente AND h.empresa = dc.Empresa
            WHERE h.cart_id = @cart_id
              AND h.empresa = @empresa
              AND dc.status = 'S'
        END
        ...
        ELSE IF @accion = 'D'
        BEGIN
            DELETE FROM FFA..ffa_tbl_txn_detail_cart WHERE cart_id = @cart_id;
            DELETE FROM FFA..ffa_tbl_txn_header_cart WHERE cart_id = @cart_id AND empresa = @empresa;
