...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            FROM FFA..ffa_tbl_txn_header_cart
        ...
        FROM FFA..CLIENTES c
        INNER JOIN FFA..LISTADO_PRECIOS lp
        ...
        IF @lista IS NULL
            SELECT TOP 1 @lista = e.lista_base FROM FFA..EMPRESA e WHERE e.cod_empresa = @empresa;
        ...
        OUTER APPLY (
            ...
            FROM FFA..Inv_UniMedArticulo iu
        ...
        WHERE pr.precio IS NOT NULL
          AND (@cart_id IS NULL OR NOT EXISTS (
                    SELECT 1 FROM FFA..ffa_tbl_txn_detail_cart dc
